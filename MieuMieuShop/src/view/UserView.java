...
public class UserView {
    ...
    public String inputPhone(InputOption option) {
        ...
        do {
            ...
            if (!ValidateUtils.isPhoneValid(phone)) {
                System.out.println("Số " + phone + " không đúng định dạng! Nhập lại!" + "Gồm 10 số và bắt đầu bằng số 0, số thứ 2 là những số 3/5/7/9!");
    ...
    private String inputEmail(InputOption option) {
        ...
        do {
            if (!ValidateUtils.isEmailValid(email = scanner.nextLine())) {
                ...
                System.out.println("Nhập email (vd: vanAA123@gmail.com)");
                System.out.print("➠");
                continue;
            }
    ...
    private String inputPassword() {
        System.out.println("Nhập mật khẩu (từ 8 đến 20 ký tự), bao gồm số, chữ cái viết hoa, ký tự đặc biệt ");
        System.out.print("➠");
        String password;
